...
public class Swagger2Config
{
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("Java Spring Back End Starting Project")
                                   ...
                                   .contact(new Contact("Larry Marcum", "http://www.lambdaschool.com", "lkmarcum@gmail.com"))
                                   .contact(new Contact("Eli Citron", "http://www.lambdaschool.com", "ebcitron@gmail.com"))
                                   .license("MIT")
